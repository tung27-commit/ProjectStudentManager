document.addEventListener("DOMContentLoaded", function () {
  ...
  // Thêm sinh viên
  document
    .querySelector("button.add-student")
  ...
  // Xóa sinh viên
  document
    .querySelector("button.delete-student")
    .addEventListener("click", function () {
  ...
  // Thêm môn học
  document
    .querySelector("button.add-subject")
    .addEventListener("click", function () {
  ...
  // Xóa môn học
  document
    .querySelector("button.delete-subject")
    .addEventListener("click", function () {
      document.getElementById("deleteSubjectPopup").style.display = "block";
    });

  document
    .getElementById("deleteSubjectForm")
    .addEventListener("submit", function (e) {
      e.preventDefault();
      const formData = new FormData(this);
      const subjectData = Object.fromEntries(formData.entries());
  ...
  document.querySelectorAll(".menu-item").forEach((item) => {
    item.addEventListener("click", function () {
      ...
      const creditManagementTable = document.getElementById(
  ...
  document
    ...
    .addEventListener("click", function (e) {
      if (e.target.tagName === "TD" && e.target.cellIndex === 2) {
        // Kiểm tra nếu click vào cột tên
  ...
  document
    .getElementById("registerSubjectForm")
    .addEventListener("submit", function (e) {
      e.preventDefault();
      const formData = new FormData(this);
      ...
      fetch("register_subjects.php", {
        ...
        .then((message) => {
          alert(message);
          document.getElementById("registerSubjectPopup").style.display =
            "none";
        })
        .catch((error) => console.error("Lỗi:", error));
    });
    ...
    fetch("get_subjects.php")
      ...
      .then((subjects) => {
        const checkboxesContainer =
          document.getElementById("subject-checkboxes");
